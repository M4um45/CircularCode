# -*- coding: utf-8 -*-
"""
Created on Sun Dec  3 08:49:13 2023
...
Z = u[2500]  # Or choose another time step to visualize # Crece hasta 150 maximo en 610
...
plt.show()
#%%
fig.savefig('modo21amortiguado.pdf', bbox_inches='tight')
#%%
fig, ax = plt.subplots()
